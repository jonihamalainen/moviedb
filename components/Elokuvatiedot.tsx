...
function Elokuvatiedot({elokuva, elokuvaKuvaus, listapituus, kesto, nayttelijaLista} : Props) : React.ReactElement {
  ...
  return (
    ...
    <div className="flex flex-row">
        ...
        <div className="pl-3 max-w-sm flex-row relative">
            ...
            <div>
                ...
                <div className="text-right">
                    ...
                    <label className="bg-inherit btn-ghost rounded-none text-blue-600 border-0" htmlFor="my-modal">lue lisää...</label>
                    ...
                    <input type="checkbox" id="my-modal" className="modal-toggle" />
                        ...
                        <div className="modal-box bg-white text-left">
                            ...
                            <label htmlFor="my-modal" className="btn text-black bg-white hover:bg-transparent">Sulje</label>
                            </div>
                        </div>
                        </div>
            ...
            <div>
                ...
                <p className="text-base my-2">Valmistumisvuosi: {elokuva.valmistumisvuosi}</p>

                <p className="text-base my-2">Tuotantomaa(t): {elokuva.tuotantomaa.toString()}</p>

                <p className="text-base my-2">{kesto} ({elokuva.kestomin} min)</p>

                <p className="text-base mt-2">Elokuvan näyttelijöitä:</p>

                <p className="text-base mb-2">{nayttelijaLista.map((nayttelija : any, idx :number)=> {
                ...
                <p className="text-base my-2">Ohjaaja(t): {elokuva.ohjaaja.toString()}</p>

            </div>

            <Link className="w-full" href="/">

                <button className="w-paluunappiDesktop rounded-full bg-red-600 p-2 hover:bg-red-800 absolute inset-x-0 bottom-0 ml-3 text-white">
                    Palaa etusivulle
                </button>
    ...
    <div className="grid grid-flow-row mt-2">
        ...
        <a href={`https://www.themoviedb.org/movie/${elokuva.tmdbid}`} target="_blank">
